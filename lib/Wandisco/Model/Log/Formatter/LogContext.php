...
namespace Wandisco\Log\Formatter;

use Traversable;
use Zend\Log\Exception;
use Zend\Log\Formatter\Simple;

class LogContext extends Simple
{
    const DEFAULT_FORMAT = '%timestamp% %priorityName% (%priority%) [%caller_class%::%caller_method(%line_number%)]: %message% %extra%';
